...
export default function Features() {
  return (
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">Unlock Your <br /> Future with Us</h1>
        ...
        <div class="mt-2 xl:mt-7 lg:flex lg:items-center">
            ...
            <div class="hidden lg:flex lg:w-1/2 lg:justify-center">
                <img class="w-[28rem] h-[28rem] flex-shrink-0 object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="https://images.pexels.com/photos/4861354/pexels-photo-4861354.jpeg?auto=compress&cs=tinysrgb&w=800" alt="" />
            </div>
        </div>
    </div>
</section>
